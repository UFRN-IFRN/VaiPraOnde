...
public class Tela4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("  O 'Vai Pra Onde?'  é um aplicativo destinado para \naqueles que utilizam rotineiramente o transporte público. \nCom o intuito de facilitar o ir e vir das pessoas, o app \noferece um guia de consultas de linhas de empresas que \nadotarem o sistema. As empresas podem cadastrar suas \nlinhas e rotas  e o usuário tem acesso a toda essa \ninformação por meio de uma interface bastante intuitiva.");
        jScrollPane1.setViewportView(jTextArea1);

        jTextArea2.setBackground(new java.awt.Color(133, 166, 202));
        jTextArea2.setColumns(20);
        jTextArea2.setFont(new java.awt.Font("Segoe Print", 0, 12)); // NOI18N
        jTextArea2.setRows(5);
        jTextArea2.setText("\t      Antonio Marcos\n\t      Bianca Cristiane\n\t       Clara Beatriz \n\t       Jaine Budke\n\t       Rafael Araújo\n\t    Talyanny Fernandes");
        jScrollPane2.setViewportView(jTextArea2);

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/inter.png"))); // NOI18N
